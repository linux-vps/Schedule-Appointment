							...
							<div class="footer-widget footer-menu">
								...
								<ul>
									...
									<li><a href=""><i class="fas fa-angle-double-right"></i>
											Register</a></li>
									<li><a href="request.getContextPath() doctor-dashboard.jsp"><i class="fas fa-angle-double-right"></i> Doctor
											Dashboard</a></li>
								</ul>
							</div>
							<!-- /Footer Widget -->
							...
							<div class="footer-widget footer-contact">
								...
								<div class="footer-contact-info">
									<div class="footer-address">
										...
										<p> T.T Phung, Dan Phuong,<br> Ha Noi</p>
									</div>
									<p>
