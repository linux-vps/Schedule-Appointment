				...
				<div class="main-menu-wrapper">
					...
					<ul class="main-nav">
						...
						<li class="has-submenu active">
							...
							<ul class="submenu">
								<li class="active"><a href="/20231IT6020003_NguyenHongSac_TX2/DoctorDashboard">Doctor Dashboard</a></li>
								...
								<li><a href="/20231IT6020003_NguyenHongSac_TX2/DoctorProfileSettings">Profile Settings</a></li>
				...
				<ul class="nav header-navbar-rht">
					...
					<li class="nav-item dropdown has-arrow logged-item">
						...
						<div class="dropdown-menu dropdown-menu-right">
							...
							<a class="dropdown-item" href="/20231IT6020003_NguyenHongSac_TX2/DoctorDashboard">Dashboard</a>
							<a class="dropdown-item" href="/20231IT6020003_NguyenHongSac_TX2/DoctorProfileSettings">Profile Settings</a>
				...
				<div class="row">
						...
						<div class="profile-sidebar">
							...
							<div class="dashboard-widget">
								<nav class="dashboard-menu">
									<ul>
										<li>
											<a href="/20231IT6020003_NguyenHongSac_TX2/DoctorDashboard">
										...
										<li class="active">
											<a href="/20231IT6020003_NguyenHongSac_TX2/DoctorProfileSettings">
					...
					<div class="col-md-7 col-lg-8 col-xl-9">
								...
								<div class="row form-row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="username" class="form-control" readonly value="${username}">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group mb-0">
											...
											<input type="text" name="dateofbirth" class="form-control value="${dateofbirth}">
										</div>
									</div>
								</div>
							</div>
						...
						<div class="submit-section submit-btn-bottom">
							<button type="submit" action="post" class="btn btn-primary submit-btn">Save Changes</button>
						</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="footer-widget footer-menu">
								...
								<ul>
									...
									<li><a href="/20231IT6020003_NguyenHongSac_TX2/DoctorDashboard"><i class="fas fa-angle-double-right"></i> Doctor
											Dashboard</a></li>
								</ul>
							</div>
							<!-- /Footer Widget -->
